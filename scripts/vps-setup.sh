...
#    7.  Creates the app directory at /var/www/orangefalcon-crm
...
cat > /etc/nginx/sites-available/orangefalcon-crm << NGINX_CONF
...
# Enable the site
ln -sf /etc/nginx/sites-available/orangefalcon-crm \
        /etc/nginx/sites-enabled/orangefalcon-crm
