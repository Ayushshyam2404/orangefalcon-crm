  ...
  return (
    <div>
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>Call Log</h1>
          <p className={styles.pageSubtitle}>Track all prospect calls</p>
        </div>
        <div style={{ display: 'flex', gap: '8px' }}>
          <Button variant="secondary" onClick={() => exportToExcel('calls-export', 'Call Log', formatCalls(calls))}>
